	...
	<div class="row footer">
	  <div class="medium-offset-3 medium-4 columns">
	    ...
	    <br />
	    <iframe src="http://www.facebook.com/plugins/like.php?href=https%3A%2F%2Fwww.facebook.com%2Fdigitaldesign.de&amp;layout=button_count&amp;show_faces=true&amp;action=like&amp;colorscheme=light" style="width:300px;height:20px;" id="lkbtn" scrolling="no" frameborder="0" allowTransparency="true"></iframe>
	    <br /> 
	  </div>
