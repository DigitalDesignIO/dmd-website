    ...
    <div class="row content flex team">
      <div class="small-12 medium-offset-3 medium-7 columns">
        <img src="<?php echo $content->picture()->toFile()->url() ?>" alt="<?php echo $content->name() ?>" width="690" height="390">
      </div>
    ...
    <div class="row content team">
      <div class="small-3 medium-offset-3 medium-1 columns">
        <img class="portrait" src="<?php echo $content->portrait()->toFile()->url() ?>" alt="<?php echo $content->name() ?>" width="100" height="100">
      </div>
